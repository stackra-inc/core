 ...
 */
export const resolvedInstances = new Map<string, any>();
 ...
 */
export function getTokenKey(token: InjectionToken): string {
 ...
 * ```
 */
export function inject<T extends object>(token: InjectionToken<T>): T {
