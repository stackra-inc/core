...
export class LazyModuleLoader {
   ...
   *   or a `DynamicModule`. Using a factory (not a direct class reference)
   ...
   */
  public async load(
    moduleFactory: () => Type<any> | DynamicModule | Promise<Type<any> | DynamicModule>
  ): Promise<Module> {
  ...
  /**
   * Extract the module class from a definition (class or DynamicModule).
   *
   * @param definition - The module class or dynamic module object
   * @returns The module class constructor
   */
  private extractModuleClass(definition: Type<any> | DynamicModule): Type<any> {
    if (typeof definition === 'function') {
      return definition;
    }
    return (definition as DynamicModule).module;
  }
}
