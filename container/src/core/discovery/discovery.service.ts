...
export class DiscoveryService {
   ...
   * ```
   */
  static createDecorator<T = object>(): IDiscoverableDecorator<T> {
   ...
   */
  public getMetadataByDecorator<D extends IDiscoverableDecorator<unknown>>(
    decorator: D,
    wrapper: InstanceWrapper,
    methodKey?: string
  ): (D extends IDiscoverableDecorator<infer R> ? R : unknown) | undefined {
    if (methodKey) {
