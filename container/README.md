...
// Usage
@Module({
  imports: [CacheModule.forRoot({ ttl: 3600, maxSize: 1000 }), CacheModule.forFeature('users')],
})
class AppModule {}
```
...
@Injectable()
class DatabaseService implements OnModuleInit, OnModuleDestroy, OnApplicationBootstrap {
