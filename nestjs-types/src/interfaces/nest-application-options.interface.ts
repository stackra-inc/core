...
import type { HttpsOptions } from './external/https-options.interface';
import type { NestApplicationContextOptions } from './nest-application-context-options.interface';
